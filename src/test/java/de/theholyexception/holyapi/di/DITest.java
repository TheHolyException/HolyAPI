...
public class DITest {
	...
	void circularDI() {
		...
		System.out.println(t3.getTestClass4());
		System.out.println(t4.getTestClass3());
		System.out.println(t4.getTestClass3().getTestClass4());

		assert t3.getTestClass4() == t4 && t4.getTestClass3() == t3;
	}
